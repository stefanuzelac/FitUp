...
public class NutritionAdapter extends RecyclerView.Adapter<NutritionAdapter.ViewHolder> {
    private List<Food> nutritionInfoList;

    public NutritionAdapter(List<Food> nutritionInfoList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Food nutritionInfo = nutritionInfoList.get(position);
    ...
    public void updateNutritionInfo(List<Food> newNutritionInfoList) {
